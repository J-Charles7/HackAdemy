...
* [Overview](#overview) 
   ...
   * [Types](#types) 
* [A. Vulnerability exploitation samples](#vulnerability-exploitation-samples)
* [B. How to test for/check SQLi](#how-to-testcheck-for-sqli)
   * [B.1. Whitebox](#whitebox)
   * [B.2. Graybox](#graybox) 
   * [B.3. Blackbox](#blackbox)
* [C. DBMS fingerprinting](#dbms-fingerprinting)
* [D. Presence detection](#presence-detection)
* [E. Countermeasures guidelines](#countermeasures-guidelines)
   * [E.1. Server side](#server-side)
   * [E.2. Client side](#client-side)
   * [E.3. Policies](#policies)
* [F. Countermeasures implementation](#countermeasures-implementation)
* [G. Attack scenairio dissect](#attack-scenario-dissect)
* [H. Common exploitation tools](#common-exploitation-tools) 
